...
- [Sensitive Documents](https://drive.google.com/drive/folders/0AAEOk_o0zstHUk9PVA?ths=true) - Restricted access. Stored on Google Workspace. Documents containing highly-confidential information.
...
- contributions@ - An email alias shared between Treasury and Fundraising. It forwards to treasurer@ and individuals on the fundraising committee. VP Fundraising can add and remove users via requests to Infra through #asfinfra or Jira tickets.
...
When you have completed your edits, submit a pull request. When someone approves the pull request, the site updates automatically.
